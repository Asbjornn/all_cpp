...
/*   Updated: 2025/10/13 16:18:25 by gcauchy          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Fixed_point {
    public:
		...
		bool operator>(const Fixed_point&);
		Fixed_point& operator<(const Fixed_point&);
		Fixed_point& operator<=(const Fixed_point&);
		Fixed_point& operator>=(const Fixed_point&);
		Fixed_point& operator==(const Fixed_point&);
		...
		static Fixed_point min(const Fixed_point& a, const Fixed_point& b);
		static Fixed_point max(Fixed_point& a, Fixed_point& b);
		static Fixed_point max(const Fixed_point& a, const Fixed_point& b);
